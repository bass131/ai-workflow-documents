...
export async function checkI18n(browser, origin, base, capture = async () => {}) {
  ...
  try {
    ...
    const docs = ['workflow/why-this-site/','workflow/overview/','workflow/goals-and-scope/','workflow/autonomy/','workflow/phase-and-resume/','workflow/verification/','projects/agentdeck/','experiments/agentdeck/','design/decisions/'];
